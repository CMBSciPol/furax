...
**Furax** is a Framework for Unified and Robust data Analysis with JAX, providing building
blocks for solving inverse problems in astrophysical and cosmological domains.
It focuses on Cosmic Microwave Background (CMB) analysis with two main components:

1. **Linear Operators** (`furax.core`): Composable linear algebra operators built on top of JAX
   and Lineax
...
🔬 **Scientific Computing**: Integration with HEALPix, AstroPy, and the broader scientific Python
ecosystem
