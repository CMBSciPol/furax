...
from furax import AbstractLinearOperator, symmetric, BlockDiagonalOperator
...
class BeamOperatorMapspace(AbstractLinearOperator):
    ...
    def __init__(self, in_structure: PyTree[jax.ShapeDtypeStruct], indices: Array, data: Array) -> None:
...
class StackedBeamOperator(AbstractLinearOperator):
    ...
    Example:
        ...
        # load files
        B_f090_i = ReadBeamMatrix(in_structure=d.structure, path_to_file='beam_sparse_256_f090_I.npz')
        B_f090_q = ReadBeamMatrix(in_structure=d.structure, path_to_file='beam_sparse_256_f090_Q.npz')
        B_f090_u = ReadBeamMatrix(in_structure=d.structure, path_to_file='beam_sparse_256_f090_U.npz')

        B_f150_i = ReadBeamMatrix(in_structure=d.structure, path_to_file='beam_sparse_256_f150_I.npz')
        B_f150_q = ReadBeamMatrix(in_structure=d.structure, path_to_file='beam_sparse_256_f150_Q.npz')
        B_f150_u = ReadBeamMatrix(in_structure=d.structure, path_to_file='beam_sparse_256_f150_U.npz')
...
class StackedBeamOperatorInverse(AbstractLinearOperator):
    """
    Inverse using the fact that StackedBeamOperator creates BlockDiagonalOperators.
    """
    ...
    def mv(self, x: PyTree[Inexact[Array, '...']]) -> PyTree[Inexact[Array, '...']]:
        ...
        for f in range(N_freq):
            ...
            inverse_beam_operators.append(StokesIQU(
                i=beam_op_freq.i.I, 
                q=beam_op_freq.q.I, 
                u=beam_op_freq.u.I
            ))
