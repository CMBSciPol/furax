...
from furax.math.quaternion import (
    Quat, Vec3, qmul, qrot, qrot_xaxis, qrot_zaxis, to_rotation_matrix,
    to_iso_angles, from_iso_angles, to_lonlat_angles, from_lonlat_angles, 
    to_xieta_angles, from_xieta_angles
)
...
class TestISOAngles:
    ...
    def test_iso_angles_z_axis_spherical_consistency(self, quaternion: Quat) -> None:
        ...
        np.testing.assert_allclose(
            rotated_z, expected_coords, atol=1e-6,
...
class TestXiEtaAngles:
    ...
    def test_xieta_batch_processing(self) -> None:
        ...
        # Normalize batch
        batch_quaternions = batch_quaternions / jnp.linalg.norm(batch_quaternions, axis=1, keepdims=True)
